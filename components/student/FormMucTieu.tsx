        ...
        {buoc === 3 && (
          <div className="flex flex-col gap-3">
            ...
            <div className="rounded-[12px] border-[1.5px] border-navy/10 p-2.5">
              <button type="button" data-kiem="mt-chat-luong" onClick={() => setMoChatLuong((v) => !v)} aria-expanded={moChatLuong} className="flex min-h-[40px] w-full cursor-pointer items-center gap-2.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold">
